...
public class Feeder extends SubsystemBase {
  ...
  private static final double DEFAULT_KP = 1.2;
  private static final double DEFAULT_KI = 0.0;
  private static final double DEFAULT_KD = 0.0;
  private static final double DEFAULT_KV = 0.099;

  public enum Speed {
    FEED(RPM.of(5600)), // 5500
    UNFEED(RPM.of(-6000));
  ...
  public Command fullPowerCommand() {
    return startEnd(this::fullPower, this::stop);
  }
  ...
  public Command unfeedCommand() {
    return startEnd(this::unFeed, this::stop);
  }
